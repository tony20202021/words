...
---
команда /study
перестала вызываться как команда
по кнопке - норм
---
тоны
фильтровать номер не более количества изученных
---
cross reference
показывать не только сумму
но и сами слова
но фильтровать номер не более количества изученных
---
- звуки
2 скачанных
+1 сгенерировать
