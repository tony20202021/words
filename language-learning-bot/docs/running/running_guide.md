...
2. **Бэкенд (REST API)** - сервер, обрабатывающий запросы и взаимодействующий с базой данных (порт 8573)
...
Если порт по умолчанию (8573) занят, вы можете указать другой порт:
