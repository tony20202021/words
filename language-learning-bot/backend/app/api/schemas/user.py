...
class UserLanguageSettingsBase(BaseModel):
    ...
    show_radicals: bool = Field(default=True, description="Show radicals")
    show_references: bool = Field(default=True, description="Show references")
    show_tones: bool = Field(default=True, description="Show tones")
    show_sounds: bool = Field(default=True, description="Show sounds")   
    random_foreign: bool = Field(default=True, description="Start randomly with foreign words")
    random_transcription: bool = Field(default=True, description="Start randomly with transcriptions")
    random_sound: bool = Field(default=True, description="Start randomly with sound")    
...
class UserLanguageSettingsUpdate(BaseModel):
    ...
    show_radicals: Optional[bool] = Field(None, description="Show radicals")
    show_references: Optional[bool] = Field(None, description="Show references")
    show_tones: Optional[bool] = Field(None, description="Show tones")
    show_sounds: Optional[bool] = Field(None, description="Show sounds")
    random_foreign: Optional[bool] = Field(None, description="Start randomly with foreign words")
    random_transcription: Optional[bool] = Field(None, description="Start randomly with transcriptions")
    random_sound: Optional[bool] = Field(None, description="Start randomly with sound")    
